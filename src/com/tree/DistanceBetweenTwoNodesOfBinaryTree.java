...
public class DistanceBetweenTwoNodesOfBinaryTree {
    ...
    public static int findDistance(Node root, int n1, int n2) {
        ...
        if (d1 != -1) { // if n1 is ancestor of n2, consider n1 as root and find level of n2 in subtree rooted with n1
            dist = findLevel(lca, n2, 0);
            return dist;
        }

        if (d2 != -1) { // if n2 is ancestor of n1, consider n2 as root and find level of n1 in subtree rooted with n2
